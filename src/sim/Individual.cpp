...
namespace EpiRisk
{
  ...
  Individual::Individual(size_t myLabel, eventTime_t myI, eventTime_t myN,
    ...
    label(myLabel), I(myI), N(myN), R(myR), contactStart(myN), known(false), isDC(false),
        sum_beta(0), sum_beta_can(0), hasBeenInfected(false), infecByContact(0)
  {
  }
